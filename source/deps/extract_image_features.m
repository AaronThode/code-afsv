...
%
%     param:  parameters for processing.  Must contain the following fields:
%       
...
%           SNRmin: 10  min dB level, for thresholding background noise
%           background.gap_f:
%           background.gap_t:
%           Centroid_freq: [1x1 struct]
%           duration: [1x1 struct]
%           dynamic_range: 3.1100 %dB below ridge maximum a pixel is allowed to have
%           dynamic_range2: 7
