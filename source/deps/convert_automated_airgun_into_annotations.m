function success_flag=convert_automated_airgun_into_annotations(list_names)
%function success_flag=convert_automated_airgun_into_annotations(list_names,filter_params)
