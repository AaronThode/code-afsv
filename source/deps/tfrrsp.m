...
for icol=1:tcol,
    ...
    %Modes : Attention, il semble que j'ai oublié le décalge de 1 entre les fréquences réel et le fréquence matricielles (la fréquence freal=0 corresond en effet à la fréquence 1 dans la matrice. 
