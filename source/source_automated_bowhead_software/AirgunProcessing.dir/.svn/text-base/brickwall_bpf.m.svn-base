...
%   [Hd, Bfilt] = brickwall_bpf(Fs,plot_on) creates a sharp bandpass filter
%   at sampling frequency Fs (Hz)
%   if intermediate plot is desired, set plot_on = 1
%   Inputs:
%           bandwidth (Hz):  four element vector: [low_pass_stopband low_pass_passband hi_pass_passband hi_pass_stopband]
%           Fs: sampling frequency in Hz
%           plot_on: plot debug information
%   Outputs:
%           Hd: filter object
%           Bfilt: actual coefficients
