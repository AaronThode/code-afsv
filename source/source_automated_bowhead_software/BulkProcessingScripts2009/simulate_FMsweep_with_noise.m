%function [y,ysignal,ynoise]=simulate_FMsweep_with_noise(Fs,Nfft,ovlap,fstart,fend,total_window_time,tduration,tstart,SNRdB,SNRchc);
...
function [y,ysignal,ynoise,noise_var]=simulate_FMsweep_with_noise(Fs,Nfft,ovlap,fstart,fend,total_window_time,tduration,tstart,SNRdB,SNRchc)
...
disp(sprintf('Narrowband Noise power in time domain: %12.8f, SNR: %12.8f dB', ...
    10*log10(Power_noise),10*log10(Power/Power_noise)));
