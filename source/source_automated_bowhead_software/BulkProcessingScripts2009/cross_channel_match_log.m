...
for Ianchor=J_anchor:Nanchors,  %Start cycling through DASARS
    ...
    for Iother=Ianchor:length(goodFile)
        ...
        tic
        [match_index,dt,dt_xcorr,best_mismatch]=match_stations_LOG(station_anchor,station(Iother),feature_params,debug_params,goodFile{Ianchor},goodFile{Iother});
        toc
