...
%
%  Notes & changes (Chris Nations, 10/21/01)
%       (1) Replaced all occurrences of boolean expression of
%       form 'x~=[]' with '~isempty(x)'.
%       (2) As written, INTSECL does not consider segments
%       per se, rather lines.  Thus, segments that do not
%       intersect will be assigned intersection points defined
%       by imaginary extensions of the segments. Avoid this
%       problem by using ISCROSS.M first, to check whether
