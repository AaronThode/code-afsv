...
%         paths.dsumry='/Volumes/BP_GSI_Data/dsumryFiles2008';
        paths.siteyear = sprintf('NA12');
        paths.raw0 = sprintf('/Volumes/2012DATAB/BP_2012/%s/Raw%s',paths.siteyear,paths.siteyear);
        paths.output='/Volumes/2012DATAB/BP_2012';
        paths.dsumry='/Volumes/2012DATAB/BP_2012/NA12/StatusNA12';
