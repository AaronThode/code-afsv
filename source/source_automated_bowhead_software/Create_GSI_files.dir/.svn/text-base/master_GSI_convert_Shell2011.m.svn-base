...
for Isite=2:2
    try
        paths.siteyear = sprintf('S%i11',Isite);
        paths.raw0 = sprintf('/Volumes/Shell_2011_S1-3/%s/Raw%s',paths.siteyear,paths.siteyear);
        paths.output='/Volumes/Shell2011_GSI_Data_Copy3';
        paths.dsumry='/Volumes/Shell2011_GSI_Data_Copy3/dsumryFiles2011';
