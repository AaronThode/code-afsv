...
for Isite=0:0
    try
        paths.siteyear = sprintf('S%i12',Isite);
        paths.raw0 = sprintf('/Volumes/2012DATAB/Shell_2012/%s/Raw%s',paths.siteyear,paths.siteyear);
        paths.output='/Volumes/Shell2012_GSI_Data';
        paths.dsumry='/Volumes/Shell2012_GSI_Data/dsumryFiles2012';
