...
%         paths.dsumry='/Volumes/BP_GSI_Data/dsumryFiles2008';
        paths.siteyear = sprintf('NA11');
        paths.raw0 = sprintf('/Volumes/BP_2011/%s/Raw%s',paths.siteyear,paths.siteyear);
        paths.output='/Volumes/BP_2011';
        paths.dsumry='/Volumes/BP_2011/NA11/StatusNA11';
