...
%         paths.dsumry='/Volumes/BP_GSI_Data/dsumryFiles2008';
        paths.siteyear = sprintf('NA10');
        paths.raw0 = sprintf('/Volumes/BP_2010/%s/Raw%s',paths.siteyear,paths.siteyear);
        paths.output='/Volumes/BP_2010';
        paths.dsumry='/Volumes/BP_2010/NA10/StatusNA10';
